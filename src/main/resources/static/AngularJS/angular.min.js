...
(function (C) {
        ...
        function d(a, b, c) {
            ...
            q(a, function (a, f) {
                if (a in n) e[f] = n[a]; else {
                    var g = a.match(d);
                    if (!g)throw ga("iscp", b, f, a, c ? "com.controller bindings definition" : "isolate scope definition");
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a, b, c, e, n, t, K, M, H, E) {
            ...
            function oa(a, b, d, e, f, g, h, k, l) {
                ...
                for (var n = -Number.MAX_VALUE,
                    ...
                    !x.templateUrl && x.controller && (w = x.controller, v = v || U(), X("'" + I + "' com.controller", v[I], x, t), v[I] = x);
    ...
    function vf() {
        ...
        this.$get =
            ["$exceptionHandler", "$parse", "$browser", function (f, g, h) {
                ...
                var J = new m, v = J.$$asyncQueue = [], w = J.$$postDigestQueue = [], t = J.$$applyAsyncQueue = [],
                    K = 0;
                return J
            }]
    }
    ...
    var Cg = /^\/(.+)\/([a-z]*)$/, ua = Object.prototype.hasOwnProperty, Q = function (a) {
        ...
        bg = [].splice, Dg = [].push, ma = Object.prototype.toString, wc = Object.getPrototypeOf, xa = N("ng"),
        ca = C.angular || (C.angular = {}), Ub, pb = 0;
    ...
    var If = [function () {
        ...
        }], Wf = /^([^\(]+?)=>/, Xf = /^[^\(]*\(\s*([^\)]*)\)/m, Eg = /,/, Fg = /^\s*(_?)(\S+?)\1\s*$/,
        Vf = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Ha = N("$injector");
                ...
                return {
                    link: function (f, g, h) {
                        ...
                        var l = h.count, m = h.$attr.when && g.attr(h.$attr.when), n = h.offset || 0, p = f.$eval(m) || {},
                            s = {}, w = b.startSymbol(), B = b.endSymbol(), r = w + l + "-" + n + B, z = ca.noop, v;
                        q(h, function (a, b) {
                            var c = e.exec(b);
